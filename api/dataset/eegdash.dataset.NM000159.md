...
Contraction intensities 50, 60 and 70 % MVC are missing for subject 15.
### Conversion
The dataset has been converted semi-automatically using the [*MUniverse*]([https://github.com/dfarinagroup/muniverse/tree/main](https://github.com/dfarinagroup/muniverse/tree/main)) software.
See *dataset_description.json* for further details.
...
|-----------|------------------------------------------------------------------------------------------|------------|
| `current` | [https://doi.org/10.7910/DVN/L9OQY7](https://doi.org/https://doi.org/10.7910/DVN/L9OQY7) |            |
