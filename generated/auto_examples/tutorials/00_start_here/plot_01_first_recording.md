...
<tr class="mne-repr-section-header general-e1503f53-c9c0-4896-b374-d0c2e45784e8"
     title="Hide section"
    onclick="toggleVisibility('general-e1503f53-c9c0-4896-b374-d0c2e45784e8')">
...
<tr class="repr-element general-e1503f53-c9c0-4896-b374-d0c2e45784e8 ">
...
<tr class="mne-repr-section-header acquisition-9d99d785-ea95-4ad5-a5dc-1295c548ed68"
     title="Hide section"
    onclick="toggleVisibility('acquisition-9d99d785-ea95-4ad5-a5dc-1295c548ed68')">
    <th class="mne-repr-section-toggle">
        <button >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"/></svg>
        </button>
...
<tr class="repr-element acquisition-9d99d785-ea95-4ad5-a5dc-1295c548ed68 ">
    <td class="mne-repr-section-toggle"></td>
    <td>Duration</td>
...
<tr class="mne-repr-section-header channels-94ecbbf3-0d40-497e-998a-0c0458e7e441"
     title="Hide section"
    onclick="toggleVisibility('channels-94ecbbf3-0d40-497e-998a-0c0458e7e441')">
    <th class="mne-repr-section-toggle">
        <button >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"/></svg>
        </button>
...
<tr class="repr-element channels-94ecbbf3-0d40-497e-998a-0c0458e7e441 ">
    <td class="mne-repr-section-toggle"></td>
    <td>EEG</td>
    <td>
...
<tr class="mne-repr-section-header filters-89d289e7-3ac3-4b3d-a662-f3484d33092e"
     title="Hide section"
    onclick="toggleVisibility('filters-89d289e7-3ac3-4b3d-a662-f3484d33092e')">
    <th class="mne-repr-section-toggle">
        <button >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"/></svg>
        </button>
...
<tr class="repr-element filters-89d289e7-3ac3-4b3d-a662-f3484d33092e ">
    <td class="mne-repr-section-toggle"></td>
    <td>Highpass</td>
    <td>0.00 Hz</td>
</tr>
...
Downloading sub-002_task-eyesclosed_channels.tsv: 100%|██████████| 284/284 [00:00<00:00, 1.24MB/s]

Downloading sub-002_task-eyesclosed_eeg.json:   0%|          | 0.00/868 [00:00<?, ?B/s]
Downloading sub-002_task-eyesclosed_eeg.json: 100%|██████████| 868/868 [00:00<00:00, 9.23kB/s]
[06/16/26 14:37:15] WARNING  File not found on S3, skipping:   downloader.py:163
...
Downloading sub-002_task-eyesclosed_eeg.set:  56%|█████▌    | 16.9M/30.3M [00:00<00:00, 75.6MB/s]
Downloading sub-002_task-eyesclosed_eeg.set:  95%|█████████▍| 28.7M/30.3M [00:00<00:00, 68.9MB/s]
Downloading sub-002_task-eyesclosed_eeg.set: 100%|██████████| 30.3M/30.3M [00:00<00:00, 66.5MB/s]
```
