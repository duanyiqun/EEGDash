...
```none
saved: /tmp/eegdash_save_9n6hw3of/windows
...
Pz_mean       float64
window_idx      int64
Parquet write_s=0.0168, read_s=0.0129, size_mb=0.0024
```
...
```none
Caught FileExistsError: Subdirectory /tmp/eegdash_save_9n6hw3of/windows/0 already exists. Please select
