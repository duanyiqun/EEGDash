...
```none
saved: /tmp/eegdash_save_p732e_io/windows
...
```none
reload OK: type=BaseConcatDataset, n=2, read_s=0.0052
```
...
```none
Zarr write_s=0.0141, read_s=0.0046, size_mb=0.0080
```
...
Pz_mean       float64
window_idx      int64
Parquet write_s=0.0130, read_s=0.0099, size_mb=0.0024
```
...
```none
Caught FileExistsError: Subdirectory /tmp/eegdash_save_p732e_io/windows/0 already exists. Please select
